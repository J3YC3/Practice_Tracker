...
insert into profiles (user_id, member_id, role, display_name, email)
select user_row.user_id, member_row.id, 'member', 'Jun Wei', 'junwei@example.com'
