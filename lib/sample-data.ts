...
export const sampleData: TeamData = {
  profiles: [
    { id: "p-admin", role: "admin", display_name: "Admin", email: "admin@example.com", require_password_reset: false, created_at: now },
    { id: "p-junwei", member_id: "m1", role: "member", display_name: "Jun Wei", email: "junwei@example.com", require_password_reset: false, created_at: now },
    { id: "p-kaixin", member_id: "m2", role: "member", display_name: "Kai Xin", email: "kaixin@example.com", require_password_reset: false, created_at: now }
  ],
  members: [
